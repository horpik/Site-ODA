    ...
    <div class="posts">
            ...
            if ($users) {
                foreach ($users as $row) {
                    ...
                    echo '<div class="col-1">'.$row['user_id'].'</div>';
                    echo '<div class="col-2">'.$row['login'].'</div>';
                    echo '<div class="col-3">'.$row['email'].'</div>';
                    echo '<div class="col-2">'.$row['description'].'</div>';
                    echo '<div class="red col-1"><a href="edit.php?edit_id='.$row['user_id'].'">edit</a></div>';
                    echo '<div class="del col-1"><a href="index.php?delete_id='.$row['user_id'].'">delete</a></div>';
                    echo '</div>';
                }
            } 
            ?>
